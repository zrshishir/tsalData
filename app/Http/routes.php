...
Route::controllers([
    ...
    'materialdetail'   => 'MaterialdetailController',
    'materialsreqform'   => 'MaterialsreqformController',
    'productprocurement'   => 'ProductprocurementController',
    'statuspro'   => 'StatusproController',
    'usergroup'   => 'UsergroupController',
    'userspro'   => 'UsersproController',
    'tsalmember' => 'TsalmemberController'
]);
